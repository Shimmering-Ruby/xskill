...
======================================
从 xskill.py 提取的 process_traj() 和 batch 相关逻辑。
"""
...
from xskill.config import get_skill_dir, get_logs_dir, get_config
from xskill.log import StreamLog
from xskill.llm_client import create_llm_client, create_embed_client
from xskill.git_lock import ensure_repo, commit_changes, has_changes, run_git
from xskill.skill_eval import run_eval, should_merge
...
from xskill.agent import run_agent
from xskill.candidates import promote_ready_candidates
