...
class Evaluator:
    ...
    用法：
        from xskill import XSkill, Evaluator
        xskill = XSkill()
        ev = Evaluator(xskill.llm, xskill.config)
        score = ev.evaluate(xskill.skill_repo['fix-foo'])
