...
from traj2skill import canary as _canary
from traj2skill import candidates as _candidates
from traj2skill.frontmatter import parse as _fm_parse
from traj2skill.types import Candidate
...
class Skill:
    ...
    def supporting_trajectories(self) -> list["Trajectory"]:
        ...
        if self._registry is None:
            return []
        from traj2skill.entities.trajectory import Trajectory as _Traj
        out: list[_Traj] = []
        for traj_id in self.source_trajs:
            ...
            # 直接按 filename 找
            from traj2skill import registry as _r
