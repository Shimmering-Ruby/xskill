...
用法 (作为库):
  from traj2skill.index import index_dataset, meta_to_index_text, parse_meta

用法 (CLI):
  t2s index /path/to/trajectories
  t2s index --dataset swe_smith_dataset
  t2s index --all --concurrency 20
"""
...
from traj2skill.llm_client import LLMClient, EmbedClient, create_embed_client, create_llm_client
